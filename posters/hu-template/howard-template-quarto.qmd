...
library(scales)
library(here)
here::i_am("howard-template-quarto.qmd") # if you change the name of your file, update this
```
...
rmarkdown::render("howard-template-quarto.qmd")

pagedown::chrome_print(
  "howard-template-quarto.html",
  output = "howard-template-quarto.pdf",
  options = list(
    paperWidth = 48, 
    paperHeight = 36
    )
